...
object Data {
    var formulas: MutableList<Formula> = mutableListOf(
            ...
            Formula("LEE","Indice de pronostico de LEE","Anestesiologia","https://image.ibb.co/iV3Phw/l.png"),

            Formula("OSMP","Osmolaridad Plasmatica","Medicina Interna","https://image.ibb.co/hioDaG/o.png"),
